...
### Action Required:
Start the interactive study session in separate terminal window using the `start_study_buddy` tool. Do not run this command in the current chat. Ask the user to run it in their terminal.
